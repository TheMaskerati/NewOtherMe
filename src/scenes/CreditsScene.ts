...
export class CreditsScene extends BaseScene {
    ...
    private createCredits(): void {
        ...
        const content = [
            ...
            { text: '', style: 'spacer' },
            { text: 'Game Design & Story', style: 'role' },
            { text: 'Gennaro "The Dreamer"', style: 'name' },
            { text: '', style: 'spacer' },
            { text: 'Programming', style: 'role' },
            { text: 'A. Attilio & Mason (AI)', style: 'name' },
            { text: '', style: 'spacer' },
            { text: 'Art & Animation', style: 'role' },
            { text: 'Procedural Generation Engine', style: 'name' },
            { text: '', style: 'spacer' },
            { text: 'Music & Sound', style: 'role' },
            { text: 'Audio placeholders', style: 'name' },
            { text: '', style: 'spacer' },
            { text: 'SPECIAL THANKS', style: 'section' },
            { text: 'Phaser 3 Community', style: 'normal' },
            { text: 'Electron & Vite', style: 'normal' },
            { text: 'Tutti i playtester', style: 'normal' },
            { text: '', style: 'spacer' },
            { text: '', style: 'spacer' },
