...
export const LOCALE = {
    ...
    DIALOGS: {
        intro_apartment: {
            lines: [
                ...
                { speaker: 'GENNARO', text: '...Ancora quel sogno.' }, { speaker: 'GENNARO', text: 'Meglio alzarsi. Stasera ho lo spettacolo.' }
            ]
        },
        generic_intro: {
            lines: [
                { speaker: 'OMBRA', text: 'Ti senti osservato.' }, { speaker: 'MASCHERA', text: 'Un\'altra prova ti attende.' },
                'L\'aria si fa pesante. Scegli la tua Maschera.'
            ]
        },
        dario_intro: {
            lines: [
                { speaker: 'DARIO', text: 'Esposito! Ancora in ritardo.' }, { speaker: 'DARIO', text: 'Sai qual è il tuo problema?' }, { speaker: 'DARIO', text: 'Non hai TALENTO. Solo ambizioni vuote.' },
                '...',
    ...
    ENEMIES: {
        dario: {
            name: 'Dario Izzo',
            attacks: [
                { name: 'Insulto', text: 'Sei solo una comparsa!' }, { name: 'Umiliazione', text: 'Non vali niente!' }, { name: 'Licenziamento', text: 'SEI FUORI!' }
            ]
        },
        bully: {
            name: 'Bullo',
            attacks: [
                { name: 'Scherno', text: 'Che sfigato!' }, { name: 'Spintone', text: 'Levati dai piedi!' }
            ]
        },
        teppista: {
            name: 'Teppista',
            attacks: [
                { name: 'Minaccia', text: 'Ti facciamo a pezzi!' }, { name: 'Pugno', text: '*WHACK*' }
            ]
        },
        elisa: {
            name: 'Elisa'
        ...
        father_shadow: {
            ...
            attacks: [
                { name: 'Delusione', text: 'Non sei mio figlio.' }, { name: 'Abbandono', text: 'Avrei dovuto lasciarti.' }, { name: 'Verita', text: 'Sei NIENTE!' }
            ]
        }
    }
};
